...
/*
Package go_micro_srv_test is a generated protocol buffer package.
...
type TestService interface {
	TestCall(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
...
func (c *testService) TestCall(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Test.TestCall", in)
	out := new(Response)
...
type TestHandler interface {
	TestCall(context.Context, *Request, *Response) error
...
func RegisterTestHandler(s server.Server, hdlr TestHandler, opts ...server.HandlerOption) error {
	type test interface {
		TestCall(ctx context.Context, in *Request, out *Response) error
...
func (h *testHandler) TestCall(ctx context.Context, in *Request, out *Response) error {
	return h.TestHandler.TestCall(ctx, in, out)
}
